...
<html lang="en">
	...
	<form action="<?php echo base_url('specialty') ?>" method="post" id="submitForm" name="submitForm">
                    ...
                    <div class="col-md-9 col-sm-9">
						  <div class="row">
								<div class="col-md-12 col-sm-12">
									<h2 class="admin_topic">Specialty</h2>
								</div>
						  </div>
							  ...
							  <div class="col-md-3 col-sm-3">
								  <button type="button" data-control="createNew" class="form-control admin_btn" id="cf-submit" >NEW SPECIALTY</button>
							  </div>
							</div>
									...
									<div class="_overFlowDiv">
										<table>
											...
											<tbody>
												...
												<tr>
													<td class="w-90"><?php echo $value->specialty ?></td>
													<td class="w-10">
...
<script>
	$(document).ready(function () {
		...
		$(document).on('click', '[data-control=createNew]', function(e) {
			...
			document.getElementById('submitForm').action = '<?php echo base_url('new-specialty') ?>';
		...
		$(document).on('click', '[data-control=edit]', function(e) {
			...
			document.getElementById('submitForm').action = '<?php echo base_url('edit-specialty') ?>';
			document.getElementById('submitForm').target= '_parent'; 
			document.getElementById('submitForm').submit(); return false;
